...
import com.atguigu.mobileactivity.view.VitamioVideoView;
...
public class VitamioPlayerActivity extends Activity implements View.OnClickListener {
    ...
    private void showSwichPlayerDialog() {
        ...
        builder.setTitle("提示")
                .setMessage("当前使用万能播放器播放视频，如果播放效果达不到您的要求，请切换到系统播放器播放试试")
...
//        }
    ...
    /**
     * 使用系统的监听播放卡,在Android4.2.2（17）以上 监听卡的处理方法
     */
...
//            Toast.makeText(SystemPlayerActivity.this, "播放出错了", Toast.LENGTH_SHORT).show();
    ...
    private void showErrorDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("提示")
                .setMessage("播放当前视频失败，请检查网络或者视频文件是否有损坏")
